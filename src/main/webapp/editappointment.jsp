    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="updateAppoint">
                    <div class="mb-3">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputLastName" type="text"  name ="pmob" placeholder="Enter your last name" value="<%out.println(session.getAttribute("pmobile"));%>">
                            </div>
                             <div class="col-md-6">
                                <label class="small mb-1" for="inputLastName">Date</label>
                                <input class="form-control" id="inputLastName" type="text"  name ="date" placeholder="Enter your last name" value="<%out.println(session.getAttribute("depart"));%>">
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLastName">Department</label>
                                <input class="form-control" id="inputLastName" type="text"  name ="dept" placeholder="Enter your last name" value="<%out.println(session.getAttribute("date"));%>">
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLastName">Doctor name</label>
                                <input class="form-control" id="inputLastName" type="text"  name ="dname" placeholder="Enter your last name" value="<%out.println(session.getAttribute("doc"));%>">
                            </div>
                        </div>
                        <!-- Form Row        -->
